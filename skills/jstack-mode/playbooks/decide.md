...
3. For high stakes, run **challenge** (multi-model) on the memo. Use `subagent_type: "jstack-judgment"` for the decision. The judgment model is scarce. Use it here, never on Triage.
