...
2. Spawn N variants on the panel from `/setup-jstack` (default 3). Each variant is a full draft, not a bullet list of tones. `subagent_type: "jstack-agent"` unless the setup rule names a panel.
